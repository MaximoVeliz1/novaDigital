...
const listaPlantillas = [
  {
    id: "imgtemp-vet-01",
    nombre: "Veterinaria",
    descripcion: "Gestión completa para clínicas veterinarias. Incluye secciones de servicios médicos, catálogo de productos especializados y un sistema de agendamiento directo. Ideal para profesionales que buscan proyectar confianza y modernidad.",
    imagenes: [
  ...
  },
  {
    ...
    descripcion: "Diseño elegante y visual enfocado en resaltar tus trabajos. Cuenta con galería de estilos, perfiles para cada barbero o estilista y un botón flotante para reservas inmediatas por WhatsApp.",
    imagenes: [
  ...
  {
    nombre: "Juguetería",
    descripcion: "Una interfaz colorida y amigable pensada para captar la atención. Organiza tus juguetes por categorías de edad o tipo de aprendizaje, facilitando la navegación de los padres.",
    imagenes: [
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 max-w-xl mx-auto">
            Haz clic en cualquier imagen para ver los detalles al estilo Instagram. 
            Diseños 100% adaptables a tu marca.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {listaPlantillas.map((item) => (
            ...
            >
              ...
              <div className="h-64 relative cursor-pointer" onClick={() => setPlantillaActiva(item)}>
                <Swiper
                ...
                <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity z-10 flex items-center justify-center pointer-events-none">
                  <span className="bg-white/90 text-gray-900 px-4 py-2 rounded-full font-bold text-sm shadow-lg">Ver Detalles</span>
                </div>
              </div>

              <div className="p-8 flex flex-col flex-grow">
                <h3 className="text-2xl font-bold text-gray-800 mb-2">{item.nombre}</h3>
                <p className="text-gray-500 text-sm mb-6 flex-grow line-clamp-2">{item.descripcion}</p>
                <button
          ...
          >
            ...
            <div className="w-full md:w-2/3 bg-gray-100 relative h-[40vh] md:h-auto">
              ...
              >
                {plantillaActiva.imagenes.map((img: string, idx: number) => (
                  <SwiperSlide key={idx}>
                    <img src={img} className="w-full h-full object-contain bg-slate-200" alt="Vista previa" />
                  </SwiperSlide>
                ))}
              </Swiper>
            </div>
            ...
            <div className="w-full md:w-1/3 p-8 md:p-12 flex flex-col bg-white">
              <div className="flex justify-between items-center mb-8">
                <h2 className="text-3xl font-black text-gray-900 tracking-tighter">{plantillaActiva.nombre}</h2>
                <button 
                  onClick={() => setPlantillaActiva(null)}
              ...
              <div className="flex-grow overflow-y-auto pr-2">
                ...
                <div className="space-y-4 mb-8">
                  <h4 className="text-xs font-black text-blue-600 uppercase tracking-widest">Incluido en el diseño:</h4>
                  <ul className="grid grid-cols-1 gap-3">
                    {['Diseño Responsive', 'Optimización de Carga', 'Integración WhatsApp', 'Panel Editable'].map((feature) => (
